...
<div class="table-responsive">
 ...
 <button type="submit" class="btn btn-sm btn-success" style="margin-top:-2px ;"> <i class="fas fa-check"></i> </button>   
    ...
    <div class="bg-primary">
        ...
        <p style="font-size:18px; color:#fff"> SubTotal : {{ round(Cart::subtotal()) }} </p>
        <p style="font-size:18px; color:#fff"> Vat : {{ round(Cart::tax()) }} </p>
        <p><h2 class="text-white"> Total </h2> <h1 class="text-white"> {{ round(Cart::total()) }}</h1>   </p>
         <br>
    </div>
