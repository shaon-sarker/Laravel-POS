  ...
  <div class="col-md-6">
        <div class="mb-3">
            <label for="firstname" class="form-label">Order Date </label>
             <p class="text-white"> {{ $order->order_date }} </p>
        </div>
    </div>
 ...
 <div class="col-md-6">
        <div class="mb-3">
            <label for="firstname" class="form-label">Order Invoice </label>
             <p class="text-white"> {{ $order->invoice_no }} </p>
        </div>
    </div>
   ...
   <div class="col-md-6">
        <div class="mb-3">
            <label for="firstname" class="form-label">Payment Status </label>
             <p class="text-white"> {{ $order->payment_status }} </p>
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="mb-3">
            <label for="firstname" class="form-label">Paid Amount </label>
             <p class="text-white"> {{ $order->pay }} </p>
        </div>
    </div>
 ...
 <div class="col-md-6">
        <div class="mb-3">
            <label for="firstname" class="form-label">Due Amount </label>
             <p class="text-white"> {{ $order->due }} </p>
        </div>
    </div>
