                  ...
                  <table id="basic-datatable" class="table dt-responsive nowrap w-100">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td>
                            <a href="{{ route('employee.attend.edit',$item->date) }}" class="btn btn-blue rounded-pill waves-effect waves-light" title="Edit"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                            <a href="{{ route('employee.attend.view',$item->date) }}" class="btn btn-info rounded-pill waves-effect waves-light" title="Details"><i class="fa fa-eye" aria-hidden="true"></i></a>
{{-- 
