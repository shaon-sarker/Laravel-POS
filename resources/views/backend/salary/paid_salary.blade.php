                        ...
                        <div class="row">
                           ...
                           <div class="col-md-6">
                              <div class="mb-3">
                                 ...
                                 <strong style="color: #fff;">{{ $paysalary['advance']['advance_salary'] ?? 'N/A' }}</strong>
                                 <input type="hidden" name="advance_salary" value="{{ $paysalary['advance']['advance_salary'] ?? '' }}">
                              </div>
                           </div>
                           @php
                           $advanceSalary = $paysalary['advance']['advance_salary'] ?? 0;
                           ...
                           <div class="col-md-6">
                              <div class="mb-3">
                                 ...
                                 @if(isset($paysalary['advance']['advance_salary']) && $paysalary['advance']['advance_salary'] !== null)
                                 {{ round($amount) }}
                                 @else
                                 <span>No Salary</span>
                                 @endif
                                 </strong>
                                 <input type="hidden" name="due_salary" value="{{ round($amount) ?? 0 }}">
                              </div>
                           </div>
                        </div>
                        <!-- end row -->
