               ...
               <div class="card-body">
                  ...
                  <div class="tab-pane" id="settings">
                     <form method="post" action="{{ route('advance.salary.store') }}" >
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-6">
                              <div class="mb-3">
                                 ...
                                 <select name="year" id="yearSelect" class="form-select @error('year') is-invalid @enderror">
                                 </select>
                                 @error('year')
                                 <span class="text-danger"> {{ $message }} </span>
                                 @enderror
                        ...
                        <!-- end row -->
                        <div class="text-end">
                           <button type="submit" class="btn btn-success waves-effect waves-light mt-2">Save</button>
                        </div>
                     </form>
                  </div>
...
// Add options for the next 10 years (you can adjust the range as needed)
for (var i = 0; i < 10; i++) {
